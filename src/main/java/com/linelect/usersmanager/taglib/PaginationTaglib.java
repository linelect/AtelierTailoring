package com.linelect.usersmanager.taglib;
...
public class PaginationTaglib extends SimpleTagSupport {
    ...
    private String constructLink(int page, String text, String className, boolean disabled) {
        ...
        if(disabled)
            ...
            String newUri = uri.replaceAll("^\\?offset=\\d+", "").replaceAll("&offset=\\d+", "");
            link.append(">").append("<a href=\""+(newUri.contains("?") ? newUri + "&" : newUri + "?")+"offset="+page + "\">"+text+"</a></li>");
        }
