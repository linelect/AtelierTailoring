...
<div class="container">
    ...
    <c:if test="${userAdded}"><div class="alert alert-success" role="alert">User was added! You can add new user or return to users list</div></c:if>


    <form:form modelAttribute="userAttribute" method="POST" action="./add" class="form-horizontal">
